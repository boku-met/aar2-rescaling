...
def main():
    ...
    for file in infiles_pr:
        ...
        def parallel_loop(y):
            ...
            pr_sum = cur_pr.resample(time="M", skipna=True).mean()
            return pr_sum
        ...
        file_attrs = {'title': 'Monthly Mean Temperature',
         'institution': 'Institute of Meteorology and Climatology, University of '
         'Natural Resources and Life Sciences, Vienna, Austria',
         'source': modelname,
         'comment': 'Monthly mean of daily mean temperatures',
         'Conventions': 'CF-1.8'}
        ...
        if path_out.endswith("/"):
            ...
            path_out += "/"
        outf = path_out + "tas_" + modelname + "_monthly_{0}-{1}.nc".format(min(years), max(years))
