...
for file in infiles_pr:
    ...
    file_attrs = {'title': 'Annual Mean Temperature',
        'institution': 'Institute of Meteorology and Climatology, University of '
        'Natural Resources and Life Sciences, Vienna, Austria',
        'source': modelname,
        'comment': 'Annual mean of daily mean temperatures',
        'Conventions': 'CF-1.8'}
    ...
    if path_out.endswith("/"):
        ...
        path_out += "/"
    outf = path_out + "tas_" + modelname + "_annual_{0}-{1}.nc".format(min(years), max(years))
